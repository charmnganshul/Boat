    ...
    <div className="flex justify-center py-10">
      <div className="w-[90%] flex flex-col gap-6  rounded-xl">
        <h1 className="text-[24px] font-bold">
          boAt Rockerz — {localStorage.getItem("category")}
        </h1>
        <div className=" flex justify-between">
          ...
          <button className="bg-gray-300 px-6 py-2 rounded-lg cursor-pointer">
            Sort By{localStorage.getItem("category")}{" "}
        ...
        <div className="w-[100%]  flex flex-wrap gap-4">
          {productList
            ...
            .map((i) => (
              <div className="flex gap-10 w-[31%] p-2 bg-[#FAF9F6] shadow-xl rounded-xl">
                ...
                <div>
                  ...
                  <button
                    ...
                    className="text-white font-bold bg-black px-2 py-2 rounded-xl my-10"
                  >
                    Add To Cart
                  </button>
                </div>
